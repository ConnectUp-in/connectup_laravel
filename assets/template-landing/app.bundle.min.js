!(function t(i, l, o) {
    ...
    for (
        var x = "function" == typeof require && require, n = 0;
        n < o.length;
        n++
    )
        M(o[n]);
...
})(
    {
        ...
        2: [
            function (n, e, c) {
                ...
                var v = {
                    deepExtend: function (n, e) {
                        for (var c in e)
                            "object" === s(e[c])
                                ? ((n[c] = e[c] instanceof Array ? [] : {}),
                                  this.deepExtend(n[c], e[c]))
                                : (n[c] = e[c]);
                    },
                    query: function (n) {
                        var s = {
        ...
        3: [
            function (n, e, c) {
                ...
                var s,
                    v,
                    t,
                    i = document.querySelectorAll(".liquid");
                if (i.length) {
                    var l = !0,
                        o = !1,
                        M = void 0;
                    try {
                        for (
                            var x, h = i[Symbol.iterator]();
                            !(l = (x = h.next()).done);
                            l = !0
                        ) {
                            var V = x.value;
                            (v = void 0),
                                (v = (s = V).querySelector("img")),
                                (t = v.getAttribute("src")),
                                (v.style.display = "none"),
                                (s.style.background = 'url("'.concat(
                                    t,
                                    '") no-repeat center'
                                )),
