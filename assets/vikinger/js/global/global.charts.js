            ...
            tooltips: {
                ...
                callbacks: {
                    label: function (tooltipItem, data) {
                        const labelText =
                            data.datasets[0].data[tooltipItem.index] + "K";
            ...
            datasets: [
                {
                    ...
                    backgroundColor: [gradient, "#293249"],
...
app.querySelector("#posts-engagement-chart", function (el) {
    ...
    const chartData = {
            datasets: [
                {
                    data: [87, 13],
                    backgroundColor: [gradient, "#e8e8ef"],
                    hoverBackgroundColor: [gradient, "#e8e8ef"],
                    borderWidth: 0,
                },
            ],
        },
...
app.querySelector("#ve-monthly-report-chart", function (el) {
    const datasetData1 = [
            20, 15, 22, 26, 12, 16, 24, 13, 17, 9, 26, 21, 14, 21, 17, 23, 30,
            18, 24, 15, 28, 17, 13, 23, 16, 12, 23, 16, 24, 13, 22,
        ],
        datasetData2 = [
            9, 28, 6, 9, 17, 7, 16, 12, 10, 11, 12, 3, 13, 11, 8, 17, 13, 16, 5,
            19, 14, 11, 26, 8, 4, 15, 16, 25, 5, 13, 12,
        ],
        canvas = el[0],
        ctx = canvas.getContext("2d"),
        chartData = {
...
app.querySelector("#rc-yearly-report-chart", function (el) {
    const datasetData1 = [
            119, 142, 110, 122, 163, 139, 143, 110, 141, 121, 139, 190,
        ],
...
app.querySelector("#earnings-report-chart", function (el) {
    const datasetData = [
            0, 15, 0, 0, 0, 20, 10, 15, 40, 20, 25, 25, 15, 10, 20, 23, 23, 15,
            30, 40, 30, 20, 25, 0, 0, 0, 0, 0, 0, 0, 0, 0,
        ],
        canvas = el[0],
        ctx = canvas.getContext("2d"),
        chartData = {
