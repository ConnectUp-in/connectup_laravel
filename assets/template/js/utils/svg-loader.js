const svgWrap = document.createElement("div"),
  ...
  <!-- SVG GITHUB -->
  <svg style="display: none;">
    <symbol id="svg-github" viewBox="0 0 24 24" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG LINKEDIN -->
  <svg style="display: none;">
    <symbol id="svg-linkedin" viewBox="0 0 24 24" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG EMAIL -->
  <svg style="display: none;">
    <symbol id="svg-email" viewBox="0 0 24 24" preserveAspectRatio="xMinYMin meet">
  ...
  <!-- SVG LOGO template -->
  <svg style="display: none;">
    <symbol id="svg-logo-template" viewBox="0 0 28 40" preserveAspectRatio="xMinYMin meet">
