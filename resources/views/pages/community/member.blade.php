...
I am delighted to announce that finally I am a part of ConnectUp community. Join us in the entrepreneurial journey and
become a part of an startup ecosystem. %0a',
      ...
      <div class="button-holder">
        ...
        <div class=" share-options nobg card-share-dropdown ">
          ...
          <div class="reaction-option text-tooltip-tft" data-title="Whatsapp">
            ...
            <a href="whatsapp://send?text={{ $message['content'] . ' ' . $message['code'] . '' . $message['link'] }}">
              <!-- REACTION OPTION
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    IMAGE -->
          ...
          <div class="reaction-option text-tooltip-tft" data-title="Copy Link">
            <a
              ...
              <!-- REACTION OPTION
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    IMAGE -->
              <img class="reaction-option-image"
                src="https://cdn3.iconfinder.com/data/icons/text-editing-2/100/Artboard_12-512.png" alt="reaction-like">
              <!-- /REACTION OPTION IMAGE -->
            </a>
          </div>
