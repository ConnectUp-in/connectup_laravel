            ...
            <div class="profile-header-info">
                ...
                <div class="user-short-description big">
                    ...
                    <a class="user-short-description-avatar user-short-description-avatar-mobile user-avatar medium no-stats"
                        ...
                        <div class="user-avatar-content">
                            <!-- HEXAGON -->
                            <div class="hexagon-image-100-110" data-src="/assets/template/img/avatar/24.jpg"></div>
                            <!-- /HEXAGON -->
                        </div>
                        <!-- /USER AVATAR CONTENT -->
                    </a>
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <p class="widget-box-status-text">
                                ...
                                cosplays, conventions, DIY, costume tips and
                                more!
                            </p>
                            <!-- /WIDGET BOX STATUS TEXT -->
                            ...
                            <a class="video-status" href="https://discordapp.com/" target="_blank">
                                <!-- VIDEO STATUS IMAGE -->
                                <img class="video-status-image" src="/assets/template/img/cover/52.jpg" alt="cover-52" />
                                <!-- /VIDEO STATUS IMAGE -->

                                <!-- VIDEO STATUS INFO -->
                                <div class="video-status-info">
                                    <!-- VIDEO STATUS META -->
                                    <p class="video-status-meta">
                                        discordapp.com
                                    </p>
                                    <!-- /VIDEO STATUS META -->
                                    ...
                                    <p class="video-status-title">
                                        ...
                                        on
                                        <span class="highlighted">Discord</span>
                                    </p>
                                    <!-- /VIDEO STATUS TITLE -->

                                    <!-- VIDEO STATUS TEXT -->
                                    <p class="video-status-text">
                                        Let's talk about everything cosplay
                                        related!.
                                    </p>
                                    <!-- /VIDEO STATUS TEXT -->
                                </div>
                                            ...
                                            <div class="reaction-item">
                                                ...
                                                <div class="simple-dropdown padded reaction-item-dropdown">
                                                    ...
                                                    <p class="simple-dropdown-text">
                                                        <img class="reaction"
                                                            src="/assets/template/img/reaction/happy.png"
                                                            alt="reaction-happy" />
                ...
                <div class="widget-box no-padding">
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <!-- WIDGET BOX STATUS TEXT -->
                            <p class="widget-box-status-text">
                                Hey! I've compiled a list of the best
                                cosplays out there for inspiration :D
                            </p>
                            <!-- /WIDGET BOX STATUS TEXT -->
                                ...
                                <div class="picture-collage-row medium">
                                    ...
                                    <div class="picture-collage-item popup-picture-trigger">
                                        ...
                                        <div class="photo-preview">
                                            ...
                                            <figure class="photo-preview-image liquid">
                                                <img src="/assets/template/img/cover/30.jpg" alt="photo-preview-30" />
                                            </figure>
                                            <!-- /PHOTO PREVIEW IMAGE -->
                                    ...
                                    <div class="picture-collage-item popup-picture-trigger">
                                        ...
                                        <div class="photo-preview">
                                            <!-- PHOTO PREVIEW IMAGE -->
                                            <figure class="photo-preview-image liquid">
                                                <img src="/assets/template/img/cover/45.jpg" alt="photo-preview-45" />
                                            </figure>
                                            <!-- /PHOTO PREVIEW IMAGE -->
                                ...
                                <div class="picture-collage-row">
                                    ...
                                    <div class="picture-collage-item popup-picture-trigger">
                                        ...
                                        <div class="photo-preview">
                                            <!-- PHOTO PREVIEW IMAGE -->
                                            <figure class="photo-preview-image liquid">
                                                <img src="/assets/template/img/cover/33.jpg" alt="photo-preview-33" />
                                            </figure>
                                            <!-- /PHOTO PREVIEW IMAGE -->
                                    ...
                                    <div class="picture-collage-item popup-picture-trigger">
                                        ...
                                        <div class="photo-preview">
                                            <!-- PHOTO PREVIEW IMAGE -->
                                            <figure class="photo-preview-image liquid">
                                                <img src="/assets/template/img/cover/44.jpg" alt="photo-preview-44" />
                                            </figure>
                                            <!-- /PHOTO PREVIEW IMAGE -->
                                    ...
                                    <div class="picture-collage-item">
                                        ...
                                        <a class="picture-collage-item-overlay" href="#">
                                            ...
                                            <p class="picture-collage-item-overlay-text">
                                                +19
                                            </p>
                                            <!-- /PICTURE COLLAGE ITEM OVERLAY TEXT -->
                                        </a>
                                        ...
                                        <div class="photo-preview">
                                            <!-- PHOTO PREVIEW IMAGE -->
                                            <figure class="photo-preview-image liquid">
                                                <img src="/assets/template/img/cover/37.jpg" alt="photo-preview-37" />
                                            </figure>
                                            <!-- /PHOTO PREVIEW IMAGE -->
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="user-status">
                                ...
                                <div class="user-status-title medium">
                                    ...
                                    <a class="bold" href="forums-discussion.html">In your opinion, who has the best
                                        Cosplay?</a>
                                    in the forum
                                    <!-- USER AVATAR -->
                            ...
                            <blockquote class="quote-box">
                                ...
                                <!-- QUOTE BOX TEXT -->
                                <p class="quote-box-text">
                                    I've been cosplaying for 9 years now and
                                    I've never seen a more perfect cosplay
                                    like the Samurai Robot one from Rosie
                                    Sakura.
                                </p>
                                <!-- /QUOTE BOX TEXT -->
                            </blockquote>
                ...
                <div class="widget-box no-padding">
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <!-- WIDGET BOX STATUS TEXT -->
                            <p class="widget-box-status-text">
                                Here's a video I made of all the awesome
                                CosplayWonder 2018!
                            </p>
                            <!-- /WIDGET BOX STATUS TEXT -->
                        </div>
                                        ...
                                        <div class="meta-line-list reaction-item-list">
                                            ...
                                            <div class="reaction-item">
                                                ...
                                                <div class="simple-dropdown padded reaction-item-dropdown">
                                                    ...
                                                    <p class="simple-dropdown-text">
                                                        <img class="reaction"
                                                            src="/assets/template/img/reaction/love.png"
                                                            alt="reaction-love" />
                                                        <span class="bold">Love</span>
                                                    </p>
                                                    <!-- /SIMPLE DROPDOWN TEXT -->
                                            ...
                                            <div class="reaction-item">
                                                ...
                                                <div class="simple-dropdown padded reaction-item-dropdown">
                                                    ...
                                                    <p class="simple-dropdown-text">
                                                        <img class="reaction"
                                                            src="/assets/template/img/reaction/like.png"
                                                            alt="reaction-like" />
                                                        <span class="bold">Like</span>
                                                    </p>
                                                    <!-- /SIMPLE DROPDOWN TEXT -->
                ...
                <div class="widget-box no-padding">
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <!-- WIDGET BOX STATUS TEXT -->
                            <p class="widget-box-status-text">
                                Sorry everyone, but from now on, I will only
                                be able to edit and upload one design
                                tutorial per month. This happens because I'm
                                having a lot on my plate right now and
                                recording and editing the tutorials requiere
                                a lot of attention.
                            </p>
                            <!-- /WIDGET BOX STATUS TEXT -->
