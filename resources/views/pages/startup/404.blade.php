@php
$page['title'] = '404 - Startup Not Found | ConnectUp ';
    ...
    <div class="content-grid">
        ...
        <div class="profile-header v2">
            ...
            <figure class="profile-header-cover liquid">
                <img src="/assets/defaults/startup404cover.png" alt="cover-29" />
            </figure>
            <!-- /PROFILE HEADER COVER -->
                ...
                <div class="user-short-description big">
                    ...
                    <a class="user-short-description-avatar user-avatar big no-stats" href="group-timeline.html">
                        ...
                        <div class="user-avatar-content">
                            <!-- HEXAGON -->
                            <div class="hexagon-image-124-136"
                                data-src="https://i.pinimg.com/736x/65/79/aa/6579aaaedde20287d08c896dbc8a2969.jpg"></div>
                            <!-- /HEXAGON -->
                        </div>
                        <!-- /USER AVATAR CONTENT -->
                    </a>
