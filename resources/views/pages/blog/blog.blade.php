            ...
            <div class="row gx-lg-8 gx-xl-12">
                ...
                <aside class="col-lg-4 sidebar mt-11 mt-lg-6">
                    ...
                    <div class="widget">
                        ...
                        <ul class="image-list">
                            @foreach (getRecentBlogs(3) as $b)
                                <li>
                                    <figure class="rounded"><a href="{{ route('blog', $b->slug) }}"><img
                                                src="{{ $b->image_compressed }}" onerror="this.src='{{ $b->image }}'"
                                                alt="" /></a></figure>
                                    <div class="post-content">
                                        <h6 class="mb-1"> <a class="link-dark" href="{{ route('blog', $b->slug) }}">
                                                {{ Str::limit($b->title, 30) }}</a> </h6>
                                        <ul class="post-meta">
                                            <li class="post-date"><i
                                                    class="uil uil-calendar-alt"></i><span>{{ $b->updated_at->diffForHumans() }}</span>
                                            </li>
                                            <li class="post-comments"><a href="#"><i
                                                        class="uil uil-eye"></i>{{ changeIntoKMG(profileview($b->id)) }}</a>
                                            </li>
                                        </ul>
                                        <!-- /.post-meta -->
                                    </div>
