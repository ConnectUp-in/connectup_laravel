                                            ...
                                            <div class="reaction-item">
                                                ...
                                                <div class="simple-dropdown padded reaction-item-dropdown">
                                                    ...
                                                    <p class="simple-dropdown-text"><img class="reaction"
                                                            ...
                                                            alt="reaction-like"> <span class="bold">Like</span>
                                                    </p>
                                                    <!-- /SIMPLE DROPDOWN TEXT -->
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    ...
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/07.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                                ...
                                <form class="form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-item">
                                            ...
                                            <div class="checkbox-wrap">
                                                <input type="radio" id="poll-option-1" name="poll_option"
                                                    value="option-1">
                                                <!-- CHECKBOX BOX -->
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-item">
                                            <!-- CHECKBOX WRAP -->
                                            <div class="checkbox-wrap">
                                                <input type="radio" id="poll-option-2" name="poll_option"
                                                    value="option-2" checked>
                                                <!-- CHECKBOX BOX -->
                                                <div class="checkbox-box round"></div>
                                                <!-- /CHECKBOX BOX -->
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-item">
                                            <!-- CHECKBOX WRAP -->
                                            <div class="checkbox-wrap">
                                                <input type="radio" id="poll-option-3" name="poll_option"
                                                    value="option-3">
                                                <!-- CHECKBOX BOX -->
                                                <div class="checkbox-box round"></div>
                                                <!-- /CHECKBOX BOX -->
                                        ...
                                        <div class="meta-line-list user-avatar-list">
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/09.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/12.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/16.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/06.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="user-status">
                                ...
                                <p class="user-status-title medium"><a class="bold"
                                        href="profile-timeline.html">Destroy Dex</a> uploaded <span class="bold">26 new
                                        photos</span></p>
                                <!-- /USER STATUS TITLE -->
                                        ...
                                        <div class="meta-line-list user-avatar-list">
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/03.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/15.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/14.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="user-status">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title medium"><a class="bold"
                                        href="profile-timeline.html">Bearded Wonder</a></p>
                                <!-- /USER STATUS TITLE -->
                                        ...
                                        <div class="meta-line-list user-avatar-list">
                                            ...
                                            <div class="user-avatar micro no-stats">
                                                ...
                                                <div class="user-avatar-content">
                                                    <!-- HEXAGON -->
                                                    <div class="hexagon-image-18-20"
                                                        data-src="/assets/vikinger/img/avatar/11.jpg">
                                                    </div>
                                                    <!-- /HEXAGON -->
                                                </div>
                                                <!-- /USER AVATAR CONTENT -->
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="user-status">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title medium"><a class="bold"
                                        href="profile-timeline.html">Nick Grissom</a> shared a <span
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="user-status">
                                ...
                                <!-- USER STATUS TITLE -->
                                <div class="user-status-title medium"><a class="bold"
                                        href="profile-timeline.html">Neko Bebop</a> replied to the discussion <a
                                        class="bold" href="forums-discussion.html">In your opinion, who has the
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="user-status">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title medium"><a class="bold"
                                        href="profile-timeline.html">Sarah Diamond</a> created a <span
                                        class="bold">poll</span></p>
                                <!-- /USER STATUS TITLE -->
