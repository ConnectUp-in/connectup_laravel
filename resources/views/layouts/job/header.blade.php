...
<header class="main-header alternate -type-12">
    <div class="auto-container">
        ...
        <div class="main-box">
            ...
            <div class="nav-outer">
                <div class="logo-box">
                    <div class="logo"><a href="index.html"><img src="/assets/template/img/landing/logo.png" alt=""
                                style="height:50px" title=""></a></div>
                </div>
            </div>
            ...
            <div class="outer-box">
                                ...
                                <div class="mega-menu-bar row pt-0">
                                    ...
                                    <div class="column col-lg-3 col-md-3 col-sm-12">
                                        <ul>
                                            ...
                                            <li class="current"><a href="index-12.html">Home Page 12</a></li>
                ...
                <!-- Login/Register -->
                <div class="btn-box">
                    <a href="login-popup.html" class="theme-btn btn-style-three call-modal">Login /
                        Register</a>
                    <a href="dashboard-post-job.html" class="theme-btn btn-style-one"><span class="btn-title">Job
                            Post</span></a>
                </div>
            </div>
        </div>
    ...
    <div class="mobile-header">
        <div class="logo"><a href="index.html"><img src="/assets/jobs/images/logo.svg" alt=""
                    title=""></a></div>
