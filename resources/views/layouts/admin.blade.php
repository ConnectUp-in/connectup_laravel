...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/assets/admin/src/assets/img/favicon.ico" />
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="./index.html">
                                <img src="/assets/template/img/landing/logo.png" alt="logo">
                            </a>
                        </div>
                        <div class="nav-item theme-text">
                            <a href="./index.html" class="nav-link"> ConnectUp </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a target="_blank" href="/assets/admin//assets/admin/documentation/index.html"
                    ...
                    <li class="menu">
                        <a target="_blank" href="/assets/admin//assets/admin/documentation/changelog.html"
                            aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
