<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu">
        <a target="_blank" href="/assets/admin//assets/admin/documentation/index.html" aria-expanded="false"
    ...
    <li class="menu">
        <a target="_blank" href="/assets/admin//assets/admin/documentation/changelog.html" aria-expanded="false"
            class="dropdown-toggle">
            <div class="">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
