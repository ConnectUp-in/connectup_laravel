            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-12 mb-5">
                <ul class="nav nav-pills d-block" id="pills-tab3" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link list-actions active" id="all-notes"><svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li class="nav-item">
                    <a class="nav-link list-actions" id="note-fav"><svg xmlns="http://www.w3.org/2000/svg" width="24"
          ...
          <div id="ct" class="note-container note-grid">
            ...
            <div class="note-item">
              <div class="note-inner-content">
                <img src="{{ is_null($event->image) ? '' : $event->image }}" alt="Note Image" style="width:100%">
                <div class="note-content">
                  <p class="note-title" data-noteTitle="{{ $event->title }}">{{ $event->title }}</p>
                  <p class="meta-time">
                  <div>Registrations Open Till: {{ Str::substr($event->r_dates[1], 0, 10) }}</div>
                  <div>Event Starts: {{ Str::substr($event->e_dates[0], 0, 10) }}</div>
                  <div>Event Ends: {{ Str::substr($event->e_dates[1], 0, 10) }}</div>
                  </p>
                  <div class="note-description-content">
                    <p class="note-description"
                      data-noteDescription="Curabitur facilisis vel elit sed dapibus sodales purus rhoncus.">
                      {{ Str::substr($event->content, 0, 100) }}
                    </p>
                  </div>
                </div>
                ...
                <div class="note-footer">
                  <div class="tags-selector btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right d-icon-menu">
                      ...
                      <a class="dropdown-item position-relative"
                        href="{{ route('superadmin.event.info', $event->id) }}">Info</a>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="d-flex note-description">
                          <textarea id="n-description" class="form-control" maxlength="60" placeholder="Description"
                            rows="3"></textarea>
                        </div>
                        <span class="validation-text"></span>
