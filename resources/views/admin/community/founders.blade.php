@php    
    $page['title'] = 'Founders - Community | ConnectUp';
@endphp
  ...
  <div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Founders</li>
      </ol>
    </nav>
  </div>
  <!-- /BREADCRUMB -->
              ...
              <td>
                <div class="d-flex">
                  <div class="usr-img-frame me-2 rounded-circle">
                    <img alt="avatar" class="img-fluid rounded-circle" src=" {{ $member->user->profile_photo_path }}">
                  </div>
